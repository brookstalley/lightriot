C:\\MinGW\\msys\\1.0\\bin\\mintty.exe /bin/bash -l -c "cd /c/Users/brook/Source/lightriot && make BOARD=saikostrobe RIOTBOARD=./boards|| read -p 'Ctrl-c to abort flashing'"
Pause About to flash...
